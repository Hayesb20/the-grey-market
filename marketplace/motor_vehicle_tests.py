...
class Make_Atv_Tests(unittest.TestCase):
	...
	def test_for_Make_Atv_1(self):
		myAtv = mvm.make_atv("1998", "yamaha", "sport", "35", "yes", "2300")
	...
	def test_for_Make_Atv_2(self):
		myAtv = mvm.make_atv(" 19 98 ", " yam aha ", " sp ort ", " 3 5 ", " y es ", " 23 00 ")	
		self.assertEqual("1998", 		myAtv.get_year())
	...
	def test_for_Make_Atv_3(self):
		myAtv = mvm.make_atv("2001", "BlaZEr", "RaptOr", "35", "YeS", "2412")	
...
class Confirm_Atv_Tests(unittest.TestCase):
	...
	def test_confirm_atv_2(self):
		myAtv = mvm.make_atv("1998", "yamaha", "sport", "35", "no", "2300")
		message = mvm.confirm_atv(myAtv)
